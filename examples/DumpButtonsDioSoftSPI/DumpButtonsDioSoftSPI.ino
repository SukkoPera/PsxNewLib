...
#include <DigitalIO.h>
#include <PsxControllerDioSoftSpi.h>
...
// These can be changed freely when using a software SPI implementation
...
PsxControllerDioSoftSpi<PIN_PS2_ATT, PIN_PS2_CMD, PIN_PS2_DAT, PIN_PS2_CLK> psx;
